...
const RedVelvetCake = () => (
  <p>
    ...
    (400g) granulated sugar <br />1 cup (240ml) canola or vegetable oil <br />4
    large eggs, room temperature and separated <br />1 Tablespoon pure vanilla
    extract <br />1 teaspoon distilled white vinegar <br />
    liquid or gel red food coloring 1 cup (240ml) buttermilk, at room
    temperature <br />
    <h2>Cream Cheese Frosting</h2>
    16 ounces (450g) full-fat block cream cheese, softened to room temperature{" "}
    <br />
    1/2 cup (115g) unsalted butter, softened to room temperature <br />4 and 1/2
    cups (540g) confectioners’ sugar <br />1 Tablespoon (15ml) heavy cream or
    milk <br />1 and 1/2 teaspoons pure vanilla extract pinch of salt, to taste{" "}
    <br />
  </p>
);
